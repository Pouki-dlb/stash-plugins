## Pouki-dlb's Stash plugins repo
This is my public repository for some [stash](https://github.com/stashapp/stash "stash") plugin i've created for my personnal usage. If it can be of use to you, I would be delighted. **They have all been largely vibecoded.**
